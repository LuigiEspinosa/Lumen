...
- [x] - Vault open: open any directory as a vault; remembers last opened vault on launch.
- [x] - File tree sidebar: directory-aware, collapsible folders, new file / rename / delete.
